...
@section('content')
    <div class="bg-white mt-5rem shadow">
        <div class="container p-4 text-center">
            <h2>Tambah Peralatan Jaringan</h2>
        </div>
    </div>
    <div class="container p-4">
        <form enctype="multipart/form-data" action="{{ url('/admin/equipment-networks/create') }}" method="post">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('link') is-invalid @enderror" name="link" id="link" rows="2"
                          placeholder="Masukkan Tautan Penjualan *">{{ old('link') ?? '' }}</textarea>
                @error('link')
                <small class="text-danger">{{ $message }} </small>
                @enderror
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content rounded-3 shadow">
                        <div class="modal-body p-4 text-center">
                            <h5 class="mb-3">Anda akan menambahkan peralatan jaringan ini?</h5>
