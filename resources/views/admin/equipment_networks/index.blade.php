...
@section('content')
    <div class="bg-white mt-5rem mb-4 shadow">
        <div class="container p-4 mx-auto">
            <h2 class="text-center text-md-start mb-4">Network Equipment</h2>
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="text-center text-md-start mb-2 mb-md-0">
                        <a href="{{ url('/admin/equipment-networks/create') }}"
                           class="btn btn-dark mb-3 mx-auto">
                            <i class="small me-2 fas fa-plus"></i>
                            Tambah Peralatan Jaringan
                        </a>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <form action="{{ url('/admin/equipment-networks/') }}" method="GET">
                ...
                @foreach($equipment_networks as $equipment)
                    <div class="col">
                        <div class="card mb-4 rounded-4 shadow-sm">
                            <div class="card-body">
                                <div class="mx-auto">
                                    <img src="{{ asset('storage/' . $equipment->image) }}" class="h-120px" alt="Network Equipment"
                                         loading="lazy">
                                </div>
                                ...
                                <div class="my-4">
                                    ...
                                    <a href="{{ $equipment->link }}">Link Penjualan</a>
                                </div>
                                <a href="{{ url('/admin/equipment-networks/' . $equipment->id . '/edit') }}" role="button"
                                ...
                                <a role="button" class="delete-button w-100 btn btn-lg btn-outline-danger"
                                   data-id="{{ $equipment->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content rounded-3 shadow">
                            <div class="modal-body p-4 text-center">
                                <h5 class="mb-3">Anda akan menghapus peralatan jaringan ini?</h5>
                                <p class="mb-0">Peralatan ini akan dihapus secara permanen. Apakah Anda
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                const equipmentNetworkId = this.getAttribute('data-id');
                const deleteForm = document.getElementById('deleteForm');
                deleteForm.action = '{{ url("/admin/equipment-networks/") }}/' + equipmentNetworkId;
            })
        })
    </script>
@endpush
