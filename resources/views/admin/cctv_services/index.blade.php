...
@section('content')
    <div class="bg-white mt-5rem mb-4 shadow">
        <div class="container p-4 mx-auto">
            <h2 class="text-center text-md-start mb-4">CCTV Services</h2>
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="text-center text-md-start mb-2 mb-md-0">
                        <a href="{{ url('/admin/cctv-services/create') }}"
                ...
                <div class="col-12 col-md-6">
                    <form action="{{ url('/admin/cctv-services/') }}" method="GET">
                ...
                @foreach($cctv_services as $service)
                    <div class="col">
                        <div class="card mb-4 rounded-4 shadow-sm">
                            <div class="card-body">
                                <div class="mx-auto">
                                    <img src="{{ asset('storage/' . $service->image) }}" class="h-120px" alt="CCTV"
                                         loading="lazy">
                                </div>
                                ...
                                <a href="{{ url('/admin/cctv-services/' . $service->id . '/edit') }}" role="button"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content rounded-3 shadow">
                            <div class="modal-body p-4 text-center">
                                <h5 class="mb-3">Anda akan menghapus paket layanan CCTV ini?</h5>
    ...
    <script>
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                const cctvServiceId = this.getAttribute('data-id');
                const deleteForm = document.getElementById('deleteForm');
                deleteForm.action = '{{ url("/admin/cctv-services/") }}/' + cctvServiceId;
            })
        })
    </script>
@endpush
